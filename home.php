    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-sidebar border-e border">
            <ul class="space-y-2 font-medium">
                ...
                ?>
                    <li>
                        <a href="/home.php?page_id=<?= $pg['id'] ?>" class="flex text-muted-foreground items-center px-2 py-1.5 hover:bg-sidebar-accent rounded-base hover:text-sidebar-accent-foreground group">
                            <i class="<?= $pg['icon'] ?>"></i>
                ...
                ?>
                <li>
                    <a href="./config/logout.php" class="flex text-muted-foreground items-center px-2 py-1.5 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground rounded-base group">
            ...
            ?>
                <main class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
                    <div class="text-center">
                        ...
                        <h1 class="mt-4 text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">Pagina no encontrada</h1>
                        ...
                        <div class="mt-10 flex items-center justify-center gap-x-6">
                            <a href="./home.php?page_id=<?= $principalPage['id'] ?>" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Volver a la página principal</a>
                            <a href="#" class="text-sm font-semibold text-gray-900">Contactar soporte <span aria-hidden="true">&rarr;</span></a>
                        </div>
                    </div>
                </main>
            <?php
