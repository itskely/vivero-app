        ...
        <form id="login-form" method="POST" class="mx-auto w-80 space-y-4">
            <div>
                ...
                <input name="cedula"
                    ...
                    id="cedula" type="text" placeholder="Cedula">
            </div>
            ...
            <div id="error-message"
                class="hidden bg-red-100 border border-red-200 mb-4 text-sm text-red-800 rounded-lg p-4 dark:bg-red-500/20 dark:border-red-900 dark:text-red-400"
            ...
            <button type="submit"
                class="block w-full rounded-lg border border-green-700 bg-green-800 px-12 py-3 text-sm font-medium text-white transition-colors hover:bg-green-700">
                Iniciar sesión
            </button>
        </form>
