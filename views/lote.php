...
<div>
    <div class="p-4" x-data="{ open: false }">
        ...
        <div x-show="open" x-transition @click="open = !open" class="fixed inset-0 z-50 bg-black/10 backdrop-blur-xs flex justify-center items-center">
            <div @click.stop class="max-w-xl w-full p-4 rounded-xl bg-card border shadow space-y-4 max-h-screen overflow-auto custom-scrollbar">
                <div>
                    <div>
                    ...
                    <div>
                        ...
                        <select id="planta_id" name="planta_id" class="input-component" required>
                            ...
                            <?php foreach ($allRoles as $rol): ?>
                                <option value="<?= $rol['id'] ?>" <?= $onePlanta && $onePlanta['planta_id'] == $rol['id'] ? 'selected' : '' ?>>
                                    <?= $rol['nombre'] ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div>
                        ...
                        <select id="unidad_medida" name="unidad_medida" class="input-component" required>
                            ...
                            <?php foreach ($allPlantas as $p): ?>
                                <option value="<?= $p['id'] ?>" <?= $onePlanta && $onePlanta['unidad_medida'] == $p['id'] ? 'selected' : '' ?>>
                                    <?= $p['nombre'] ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div>
                        ...
                        <select id="etapa_id" name="etapa_id" class="input-component" required>
                            ...
                            <?php foreach ($allEtapas as $p): ?>
                                <option value="<?= $p['id'] ?>" <?= $onePlanta && $onePlanta['etapa_id'] == $p['id'] ? 'selected' : '' ?>>
                                    <?= $p['nombre'] ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div>
                        ...
                        <select id="ubicacion_id" name="ubicacion_id" class="input-component" required>
                            ...
                            <?php foreach ($allUbicaciones as $p): ?>
                                <option value="<?= $p['id'] ?>" <?= $onePlanta && $onePlanta['ubicacion_id'] == $p['id'] ? 'selected' : '' ?>>
                                    <?= $p['nombre'] ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
