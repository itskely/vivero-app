<?php
include __DIR__ . "/../controllers/DestinoController.php";
?>
        ...
        <form method="POST" class="max-w-sm mx-auto space-y-4">
            <?=
                Form::input(
                    ...
                    "nombre",
                    "nombre",
                    $oneDestino ? $oneDestino['nombre_destino'] : "",
                    "Nombre"
                );
            ?>
            <?=
                Form::textarea(
                    "descripcion",
                    "descripcion",
                    $oneDestino ? $oneDestino['descripcion'] : "",
                    "Descripción"
                );
            ?>
            ...
            <tbody>
                ...
                foreach ($allDestinos as $ds)
                {
                    ...
                    <tr class="bg-neutral-primary border-b border-default">
                        ...
                        <td class="px-6 py-4">
                            <a href="/home.php?page_id=<?= $pageAccessed['id'] ?>&id=<?= $ds['id'] ?>"
                            ...
                            <button onclick="function eliminar() {
                                    if (confirm('¿Estás seguro de que deseas eliminar este destino?')) {
                                        window.location.href = '/home.php?page_id=<?= $pageAccessed['id'] ?>&delete_id=<?= $ds['id'] ?>';
                                    }
                                }
