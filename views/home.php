    ...
    <div>
        <form action="/home.php" method="get" class="p-4 max-w-sm">
            ...
            <div class="relative">
                ...
                <input type="search" id="search" name="busqueda" value="<?= $_GET['busqueda'] ?? "" ?>"
                    class="block w-full p-6 ps-9  input-component placeholder=" Buscar..." />
                <button type="submit"
                    class="absolute inset-e-1.5 bottom-1.5 text-primary-foreground bg-primary hover:bg-green-700 box-border border border-transparent focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded text-xs px-3 py-1.5 focus:outline-none">Buscar</button>
            </div>
        </form>
    </div>
        ...
        foreach ($allPlants as $pg)
        {
            ...
            <div class="bg-neutral-primary-soft block max-w-sm border border-default rounded-base shadow-xs">
                ...
                <div class="p-6 text-left">
                    ...
                    <div>
                        <h5 class="mt-3 mb-6 text-2xl font-semibold tracking-tight text-heading"><?= $pg['nombre_comun'] ?>
                        </h5>
