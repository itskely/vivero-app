...
<div>
    <div class="p-4" x-data="{ open: true }">
        ...
        <div x-show="open" x-transition @click="open = false"
            ...
            <div @click.stop
                class="max-w-4xl w-full p-6 rounded-xl bg-card border space-y-6 max-h-screen overflow-auto custom-scrollbar">
                <div>
                ...
                <form method="POST" class="space-y-6" id="form-cambiar-etapa">
                    ...
                    <?= Form::input("hidden", "lote", "lote", "", "Buscar lote", "Código del lote") ?>
                    ...
                    <div class=" relative">
                        ...
                        <div
                            ...
                            <input type="text" placeholder="Buscar lote..."
                                class="input-component bg-muted! sticky top-0 z-10">
                            ...
                            <template id="template-stock">
                                <button data-stock-item type="button"
                                    ...
                                    <div class="flex items-center gap-3">
                                        <span
                                            class="inline-flex items-center font-medium rounded-full border bg-emerald-100 text-emerald-700 border-emerald-300 px-2 py-0.5 text-xs">
                                            <span class="w-1.5 h-1.5 rounded-full mr-1.5 bg-emerald-500"
                                                data-dot></span>
                                            <span data-etapa></span>
                                        </span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="p-4 border rounded-xl bg-destructive/10 space-y-3 mt-2">
                            ...
                            <div>
                                ...
                                <select name="etapa_origen_id" class="input-component" id="etapa_origen_id">
                            ...
                            <div>
                                ...
                                <select name="ubi_origen_id" class="input-component" id="ubi_origen_id">
                                    <option disabled selected>Seleccionar...</option>
                            ...
                            <div class="text-sm p-2 rounded bg-card border">Stock disponible: <span
                                    class="font-bold tabular-nums" data-stock-origen></span></div>
                        </div>
                            ...
                            <div class="flex-1">
                                ...
                                <div class="mt-2 space-y-1">
                                    <div class="flex justify-between text-sm"><span
                                            class="text-muted-foreground">Cantidad que
