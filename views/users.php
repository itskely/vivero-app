            ...
            <div @click.stop class="max-w-xl w-full p-4 rounded-xl bg-card border space-y-4">
                <div>
                    ...
                    <div>
                        ...
                        <p class="text-muted-foreground text-sm">Llena todos los campos requeridos y envia el formulario para generar un nuevo usuario.</p>
                    </div>
                </div>

                <form method="POST" class="max-w-sm mx-auto space-y-4">
                    <div>
                        <label for="nombre_completo" class="block mb-2.5 text-sm font-medium text-heading">Nombre completo</label>
                        <input
                            type="text"
                            id="nombre_completo"
            ...
            <tbody>
                ...
                ?>
                    <tr class="bg-neutral-primary border-b border-default">
                        ...
                        <td class="px-6 py-4">
                            <a href="/home.php?page_id=<?= $pageAccessed['id'] ?>&id=<?= $user['id'] ?>" class="font-medium text-blue-600 hover:underline"><i class="fa-regular fa-pen-to-square"></i>Editar</a>
                            <button
