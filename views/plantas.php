            ...
            <div @click.stop class="max-w-xl w-full p-4 rounded-xl bg-card border space-y-4">
                <div>
                    ...
                    <div>
                        ...
                        <p class="text-muted-foreground text-sm">Llena todos los campos requeridos y envia el formulario para registrar una nueva especie.</p>
                    </div>
                </div>

                <form method="POST" enctype="multipart/form-data" class="max-w-sm mx-auto space-y-4">
                    <div>
                        <label for="nombre_cientifico" class="block mb-2.5 text-sm font-medium text-heading">Nombre cientifico</label>
                        <input
                            type="text"
                            ...
                            required
                            value="<?= $onePlanta ? $onePlanta['nombre_cientifico'] : "" ?>" />
                    </div>
                    <div>
                        <label for="nombre_comun" class="block mb-2.5 text-sm font-medium text-heading">Nombre común</label>
                        <input
                            type="text"
                            id="nombre_comun"
                            name="nombre_comun"
                    ...
                    <div>
                        ...
                        <input class="cursor-pointer bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full shadow-xs placeholder:text-body"
                            ...
                            type="file"
                            name="imagen">
                        <div id="image-div" class="relative mx-auto my-2 overflow-hidden items-center justify-center rounded-full size-20 border-green-500 border-2 hidden">
                ...
                ?>
                    <tr class="bg-neutral-primary border-b border-default">
                        ...
                        <td class="px-6 py-4">
                            ...
                            if ($pg['imagen']):
                            ?>
                                <div class="relative mx-auto my-2 overflow-hidden items-center justify-center rounded-full size-20 border-green-500 border-2">
                                    <img src="/assets/uploads/<?= $pg['imagen'] ?>" alt="<?= $pg['nombre_comun'] ?>" class="object-center object-cover">
                                </div>
                            <?php
                            else:
                            ?>
